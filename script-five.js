...
for (let number = 1; number > 0 ; index++) {  // Нельзя создавать циклы, в которых существует только значение "true", иначе он будет бесконечным и браузер зависнет. Например, в данном случае значение переменной всегда будет больше 0 и цикл не завершится
